    ...
    <main class="main">
        ...
        <div class="topbar">
            <div class="page-title">
                <h1>新增上架服務</h1>
                <p>
                    建立一筆你想提供給其他使用者的服務內容。填寫完成後，系統會將資料新增到服務資料表中。
                </p>
            </div>
        ...
        <div class="content-layout">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/service/service.do">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="serviceTypeId" name="serviceTypeId" placeholder="例如：1">
                                <div class="field-hint">對應 SERVICE_TYPE_ID，目前先以編號測試。</div>
                            </div>

                            <div class="form-group">
                                <label for="memberId">會員編號 <span class="required">*</span></label>
                                <input type="number" id="memberId" name="memberId" placeholder="例如：1">
                                <div class="field-hint">開發測試用。正式登入後會改由 session 自動取得。</div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="serviceName">服務名稱 <span class="required">*</span></label>
                            <input type="text" id="serviceName" name="serviceName" placeholder="例如：週末咖啡廳聊天陪伴">
                        </div>

                        <div class="form-group">
                            <label for="description">服務描述 <span class="required">*</span></label>
                            <textarea id="description" name="description" placeholder="請簡單描述這項服務的內容、適合對象、注意事項等。"></textarea>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label for="hourlyRate">每小時費率 <span class="required">*</span></label>
                                <input type="number" id="hourlyRate" name="hourlyRate" placeholder="例如：500">
                                <div class="field-hint">單位可先視為新台幣 / 小時。</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field-hint">正式版可改成審核中、已上架、已下架等狀態。</div>
                            </div>
                        </div>
            ...
            <aside class="panel">
                ...
                <div class="panel-body">
                    <div class="info-box">
                        目前尚未串接登入系統，因此會員編號暫時需要手動輸入。之後登入完成後，這個欄位應該移除。
                    </div>

                    <div class="warning-box">
                        正式上線時，使用者不應該自行輸入會員編號，避免冒用其他會員身分建立服務。
                    </div>
