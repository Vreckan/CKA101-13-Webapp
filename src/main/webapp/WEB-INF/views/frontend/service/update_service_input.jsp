		...
		<main class="main">
			...
			<div class="topbar">
				<div class="page-title">
					<h1>修改服務資料</h1>
					<p>編輯目前這筆服務的基本內容。服務編號與建立時間不可修改，其他欄位可依實際需求更新。</p>
				</div>
			...
			<c:if test="${not empty serviceVO}">
				...
				<div class="content-layout">
							...
							<form method="post"
								...
								<div class="form-row">
									<div class="form-group">
										<label for="serviceId">服務編號</label> <input type="number"
											id="serviceId" name="serviceId"
											value="${serviceVO.serviceId}" readonly>
										<div class="field-hint">主鍵不可修改。</div>
									</div>

									<div class="form-group">
										<label for="createdAt">建立時間</label> <input type="text"
											id="createdAt" value="${serviceVO.createdAt}" readonly>
					...
					<aside class="panel">
						...
						<div class="panel-body">
							<div class="info-box">
								此頁會將表單送到 <strong>/service/update</strong>， 並由 Spring MVC 的 <strong>@PostMapping("/update")</strong>
								執行更新流程。
							</div>

							<div class="warning-box">正式上線後，會員編號不應開放使用者自行修改，應由登入 session
								判斷目前會員身分。</div>
